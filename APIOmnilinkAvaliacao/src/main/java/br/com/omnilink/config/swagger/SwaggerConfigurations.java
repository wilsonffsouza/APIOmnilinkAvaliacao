package br.com.omnilink.config.swagger;

import java.util.Arrays;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import br.com.omnilink.utils.HostPropertiesUtil;
...
public class SwaggerConfigurations {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.omnilink"))
    ...
    private ApiInfo apiInfo() {
        ...
        ApiInfo apiInfo = new ApiInfoBuilder()
                .title("API Omnilink Avaliação REST")
                ...
                .contact(new Contact("Suporte Omnilink", "https://showtecnologia.movidesk.com/", null))
                .build();
